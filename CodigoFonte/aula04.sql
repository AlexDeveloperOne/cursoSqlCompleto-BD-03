...
SELECT * FROM funcionaveiculosveiculosrios;
...
SET SQL_SAFE_UPDATES = FALSE;/*OU 0*/
/*PARA VOLTAR: SET SQL_SAFE_UPDATES = TRUE; OU 0 */
...
SELECT nome AS 'Canalha', salario FROM funcionarios f WHERE f.salario > 2000;

SELECT * FROM funcionarios WHERE nome = 'Guilherme'
UNION/*unindo os dois comandos ou resultados*/
...
SELECT * FROM funcionarios WHERE nome = 'Guilherme'
UNION ALL/*NAO ELIMINA REGISTROS DUPLICADOS*/
SELECT * FROM funcionarios WHERE nome = 'Guilherme';